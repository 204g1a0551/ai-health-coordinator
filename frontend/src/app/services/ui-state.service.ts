...
export class UIStateService {
  ...
  private normalizeAction(action: string): UIActionType {
    ...
    switch (act) {
      ...
      case 'SHOW_BILL_COMPARISON': return 'SHOW_BILL_COMPARISON';
      case 'SHOW_BILL_DETAILS': return 'SHOW_BILL_DETAILS';
      case 'SHOW_VERIFICATION_EVIDENCE': return 'SHOW_VERIFICATION_EVIDENCE';
